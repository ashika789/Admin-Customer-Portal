                ...
                <Card>
                  <CardBody>
                    ...
                    <div class="progress mb-3" style={{height: "10px"}}>
                      <div class="progress-bar bg-danger" role="progressbar" style={{"width": "25%"}} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">Order Products</div>
                  <div class="progress-bar bg-warning" role="progressbar" style={{"width": "25%"}} aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">Event Info</div>
...
<div class="progress-bar bg-info" role="progressbar" style={{"width": "20%"}} aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">Estimate</div>
                  <div class="progress-bar bg-info" role="progressbar" style={{"width": "20%"}} aria-valuenow="80" aria-valuemin="0" aria-valuemax="100">Final Invoice</div>

 <div class="progress-bar bg-success" role="progressbar" style={{"width": "20%"}} aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">Payment</div>
                    ...
                    >
                      ...
                      <ul className="pager wizard twitter-bs-wizard-pager-link">
                        <li className={this.state.activeTab === 1 ? "previous" : "previous "}><Link to="/ecommerce-invoice" onClick={() => { this.toggleTab(this.state.activeTab - 1); }}>Final Invoice</Link></li>
                        <li className={this.state.activeTab === 3 ? "next" : "next"}><Link to="/ecommerce-orders" onClick={() => { this.toggleTab(this.state.activeTab + 1); }}>Mark as Paid</Link></li>
                      </ul>
                    </div>
                  </CardBody>
                </Card>
