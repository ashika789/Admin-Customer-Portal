                  ...
                  <div class="progress-bar bg-warning" role="progressbar" style={{"width": "20%"}} aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">Event Info</div>
                    ...
                    >
                      ...
                      >
                        <TabPane tabId={1}>
                          <CardTitle className="h5">
                            Please enter details regarding your event:
                      ...
                      <ul className="pager wizard twitter-bs-wizard-pager-link">
                        <li className={this.state.activeTab === 1 ? "previous" : "previous"}><Link to="/ecommerce-cart" onClick={() => { this.toggleTab(this.state.activeTab - 1); }}>Previous</Link></li>
                        <li className={this.state.activeTab === 3 ? "next" : "next"}><Link to="/ecommerce-estimate" onClick={() => { this.toggleTab(this.state.activeTab + 1); }}>Next</Link></li>
                      </ul>
                    </div>
                  </CardBody>
                </Card>
