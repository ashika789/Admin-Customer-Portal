                        ...
                        <tbody>
                          {map(productList, (product) => (
                            <tr key={product.id}>
                             ...
                             <td class="text-center"> {product.data_attr}</td>
...
<br />
          <a href="/ecommerce-checkout"> 
                   <button type="button" class="disabled btn btn-primary waves-effect waves-light" style={{float:'left'}} >
                      <i class=""></i> Estimate
                      </button>
                    </a> 

                    <a href="/ecommerce-payment"> 
                   <button type="button" class="btn btn-primary waves-effect waves-light" style={{float:'right'}} >
                          Payment <i class="ri-arrow-right-line ms-2"></i> 
                      </button>
                    </a> 
                    </div>
                    <br />
