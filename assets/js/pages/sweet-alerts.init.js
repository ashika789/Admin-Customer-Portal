! function(t) {
    ...
    e.prototype.init = function() {
        t("#sa-basic").on("click", function() {
            ...
            Swal.fire({
                title: "Estimate Recieved!",
                text: "Someone will review your order and provide an estimate shortly. You'll be notified when it is ready.",
                icon: "success",
                // showCancelButton: !0,
                confirmButtonColor: "#5664d2",
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "You won't be able to revert this! You will need to re-submit your products and wait for a new estimate.",
                icon: "warning",
                showCancelButton: !0,
                ...
                t.value && Swal.fire("Deleted!", "Your order has been deleted.", "success")
                //Need to redirect to ecommerce-cart page after with automatic re-direct.
            })
        }), t("#sa-params").click(function() {
            Swal.fire({
                title: "Are you sure you want to cancel this estimate?",
                text: "You won't be able to revert this! You will need to re-submit your products and wait for a new estimate.",
                icon: "warning",
                showCancelButton: !0,
